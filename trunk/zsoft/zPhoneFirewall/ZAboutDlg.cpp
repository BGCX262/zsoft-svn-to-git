    ...
    :MyBaseDlg()
{
  ...
  setMainWidgetTitle ( "zPhoneFirewall" );
  ...
  myLabel = new QLabel ( QString ( "<qt><img src=%1/images/icon.png><br>"
                                   "<font size=\"+1\">zPhoneFirewall</font><font size=\"-1\">"
                                   "  v0.1 RC2<br><br>Motorola Z6 Linuxmod<br>www.modmymoto.com<br>"
                                   "<br>(C) 2008. <br>CepiPerez"
